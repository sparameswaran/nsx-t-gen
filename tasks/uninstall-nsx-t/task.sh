...
echo "If canncelled, the deletion of the NSX VMs  up as well as removal of vibs from Esxi hosts needs to be done manually!!"

echo "Manual NSX-T Vib removal command:"
